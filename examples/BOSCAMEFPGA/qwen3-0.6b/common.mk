# ===- common.mk - Shared NR operator build ------------------------------===
#
# Shared build for one kernel.mlir + launch.c operator directory. Part of the
# NR operator example suite.
#
# ===----------------------------------------------------------------------===
...
BUDDY_BIN ?= $(firstword $(foreach dir,$(REPO_ROOT)/build/bin,$(if $(wildcard $(dir)/buddy-opt),$(dir))))
