// Per-token quantization from f32 to int8 (quantize_1x3072). Part of the NR
...
module {
  func.func @kernel_quantize_1x3072(
      %x: memref<1x3072xf32>,
      %q: memref<1x3072xi8>,
    ...
    linalg.generic {
      ...
      ins(%x, %scale : memref<1x3072xf32>, memref<1xf32>)
      outs(%q : memref<1x3072xi8>) {
