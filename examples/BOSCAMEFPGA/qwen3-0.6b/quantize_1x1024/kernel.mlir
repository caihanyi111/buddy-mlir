// Per-token quantization from f32 to int8 (quantize_1x1024). Part of the NR
...
module {
  func.func @kernel_quantize_1x1024(
      %x: memref<1x1024xf32>,
      %q: memref<1x1024xi8>,
    ...
    linalg.generic {
      ...
      ins(%x, %scale : memref<1x1024xf32>, memref<1xf32>)
      outs(%q : memref<1x1024xi8>) {
