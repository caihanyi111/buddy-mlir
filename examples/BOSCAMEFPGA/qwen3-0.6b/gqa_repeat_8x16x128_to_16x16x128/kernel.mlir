...
// head_dim axes (gqa_repeat_8x16x128_to_16x16x128, f32). Part of the NR operator
// example suite; see ../../common/README.md for provenance.

#map = affine_map<(d0, d1, d2) -> (d0, d1, d2)>

module {
  func.func @kernel_gqa_repeat_8x16x128_to_16x16x128(
    ...
    ^bb0(%v0: f32):
      ...
      %value = memref.load %x[%kv_head, %t, %d] : memref<8x16x128xf32>
